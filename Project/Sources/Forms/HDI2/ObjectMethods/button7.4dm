...
Case of 
	...
	: (Form event code:C388=On Load:K2:1)
		...
		$left:=z_getPictureFromResources("images/shocked.png")
		$right:=z_getPictureFromResources("images/happy.png")
		$toggle:=z_getPictureFromResources("images/backgroundYN.png")
